...
public class Born2002UpdateSuccess {
    ...
    private boolean meetAllAddCondi(Artist artist) {
        ...
        List<String> oldOccupations = Arrays.asList("Singer","Songwriter");
...
//    }
    ...
    public static void main(String[] args) {
        ArrayList<String> occupations = new ArrayList<>(Arrays.asList("Singer", "SongDancer"));
//        ArrayList<String> occupations = new ArrayList<>(Arrays.asList("Player", "BigBoss"));
